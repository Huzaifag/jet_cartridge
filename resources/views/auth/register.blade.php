                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="text-center mb-4">
                                <div class="position-relative d-inline-block">
                                    <label for="profile_picture" class="profile-picture-wrapper mb-0" style="cursor: pointer;">
                            ...
                            <div class="mb-4">
                                <div class="form-floating glass-input">
                                    <input type="email" name="email" class="form-control bg-transparent @error('email') is-invalid @enderror" 
                                ...
                                <div class="row g-3">
                                    <div class="col-4">
                                        <label class="w-100 h-100">
                                            <input type="radio" name="role" value="user" class="btn-check" autocomplete="off" checked>
                                    ...
                                    <div class="col-4">
                                        <label class="w-100 h-100">
                                            <a href="{{ route('seller.register') }}" class="text-decoration-none">
                                                <div class="card h-100 border-2 hover-shadow cursor-pointer role-card">
                                                    <div class="card-body text-center p-4">
                                            ...
                                            <a href="{{ route('seller.register') }}" class="text-decoration-none">
                                                <div class="card h-100 border-2 hover-shadow cursor-pointer role-card">
                                                    <div class="card-body text-center p-4">
                                                        ...
                                                        <h5 class="card-title mb-0">Regional Seller</h5>
                                                    </div>
                                                </div>
                                            </a>
                                        </label>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    <div class="form-floating glass-input">
                                        <input type="password" name="password" class="form-control bg-transparent @error('password') is-invalid @enderror" 
                            ...
                            <div class="text-center">
                                <p class="text-muted mb-0">Already have an account? 
                                    <a href="{{ route('login') }}" class="text-decoration-none link-primary">Sign in</a>
                                </p>
                            </div>
                        </form>
                    </div>
