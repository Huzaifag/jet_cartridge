...
@section('content')
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('seller.employees.sales_man.orders') }}" class="btn btn-outline-secondary order-action-btn">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                @if ($order->customer->hasRole('retailer'))
                                    <a href="{{ route('seller.employees.sales_man.orders.order-split', $order->id) }}"
                                ...
                                <a href="{{ route('seller.employees.sales_man.orders.print-invoice', $order->id) }}"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('seller.employees.sales_man.orders.update-status', $order->id) }}" id="orderReviewForm"
                    method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
