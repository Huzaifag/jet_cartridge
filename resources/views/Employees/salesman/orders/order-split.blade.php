...
@section('content')
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('seller.employees.sales_man.orders') }}" class="btn btn-outline-secondary">
        ...
        <!-- Split Form -->
        <form action="{{ route('seller.employees.sales_man.orders.split.store', $order->id) }}" method="POST">
            @csrf
