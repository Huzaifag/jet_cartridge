            ...
            <div class="user-dropdown">
                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" role="button"
                    ...
                    <div class="avatar bg-primary text-white rounded-circle me-2">
                        {{ strtoupper(substr(Auth::guard('seller')->user()->company_name, 0, 1)) }}
                    </div>
                    <div class="d-none d-md-block">
                        <div class="fw-bold">{{ Auth::guard('seller')->user()->company_name }}</div>
                        <div class="small text-muted">Seller Account</div>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="userDropdown">
                    <li class="dropdown-header">
                        <h6 class="mb-0">{{ Auth::guard('seller')->user()->company_name }}</h6>
